...
unique_ptr<Domain> constructDomain(const string &description) {
    ...
    unordered_map<string, function<unique_ptr<Domain>(vector<string>)>> domainsTable = {
        ...
        {"KS_SILVERMAN4BY4", [ ](vector<string>) { return make_unique<KriegspielDomain>(1000, 1000, chess::BOARD::SILVERMAN4BY4); }},
        {"KS_MINIMAL3x3",    [ ](vector<string>) { return make_unique<KriegspielDomain>(1000, 1000, chess::BOARD::MINIMAL3x3); }},
