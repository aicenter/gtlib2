...
unique_ptr<Domain> constructDomain(const string &description) {
    ...
    unordered_map<string, function<unique_ptr<Domain>(vector<string>)>> domainsTable = {
        ...
        {"IIGS_2",     [ ](vector<string>)   { return GoofSpielDomain::IIGS(2); }},
        {"IIGS_3",     [ ](vector<string>)   { return GoofSpielDomain::IIGS(3); }},
        {"IIGS_4",     [ ](vector<string>)   { return GoofSpielDomain::IIGS(4); }},
        {"IIGS_5",     [ ](vector<string>)   { return GoofSpielDomain::IIGS(5); }},
        {"IIGS_6",     [ ](vector<string>)   { return GoofSpielDomain::IIGS(6); }},
        {"IIGS_13",    [ ](vector<string>)   { return GoofSpielDomain::IIGS(13); }},
        {"IIGS_small", [ ](vector<string>)   { return GoofSpielDomain::IIGS(5); }},
        {"IIGS_large", [ ](vector<string>)   { return GoofSpielDomain::IIGS(13); }},
        {"GS",         [&](vector<string> p) { return parseGoofspiel(p, GoofSpielVariant::CompleteObservations); }},
        {"GS_2",       [ ](vector<string>)   { return GoofSpielDomain::GS(2); }},
        {"GS_3",       [ ](vector<string>)   { return GoofSpielDomain::GS(3); }},
        {"GS_4",       [ ](vector<string>)   { return GoofSpielDomain::GS(4); }},
        {"GS_5",       [ ](vector<string>)   { return GoofSpielDomain::GS(5); }},
        {"GS_6",       [ ](vector<string>)   { return GoofSpielDomain::GS(6); }},
        {"IIOZ",       [&](vector<string> p) { return parseOshizumo(p, OshiZumoVariant::IncompleteObservation); }},
        {"IIOZ_2",     [ ](vector<string>)   { return OshiZumoDomain::IIOZ(2); }},
        {"IIOZ_3",     [ ](vector<string>)   { return OshiZumoDomain::IIOZ(3); }},
        {"IIOZ_4",     [ ](vector<string>)   { return OshiZumoDomain::IIOZ(4); }},
        {"IIOZ_5",     [ ](vector<string>)   { return OshiZumoDomain::IIOZ(5); }},
        {"IIOZ_6",     [ ](vector<string>)   { return OshiZumoDomain::IIOZ(6); }},
        {"0Z",         [&](vector<string> p) { return parseOshizumo(p, OshiZumoVariant::CompleteObservation); }},
        {"0Z_2",       [ ](vector<string>)   { return OshiZumoDomain::OZ(2); }},
        {"0Z_3",       [ ](vector<string>)   { return OshiZumoDomain::OZ(3); }},
        {"0Z_4",       [ ](vector<string>)   { return OshiZumoDomain::OZ(4); }},
        {"0Z_5",       [ ](vector<string>)   { return OshiZumoDomain::OZ(5); }},
        {"0Z_6",       [ ](vector<string>)   { return OshiZumoDomain::OZ(6); }},
        {"MP",         [ ](vector<string>)   { return make_unique<MatchingPenniesDomain>(); }},
        {"RPS",        [ ](vector<string>)   { return make_unique<RPSDomain>(); }},
        {"BRPS",       [ ](vector<string> p) { return make_unique<BiasedRPSDomain>(stod(p.at(0))); }},
        {"PD",         [ ](vector<string>)   { return make_unique<PrisonnersDilemmaDomain>(); }},
        {"GP_322221",  [ ](vector<string>)   { return make_unique<GenericPokerDomain>(3,2,2,2,2,1); }},
        {"GP_464441",  [ ](vector<string>)   { return make_unique<GenericPokerDomain>(4,6,4,4,4,1); }},
        {"GP_small",   [ ](vector<string>)   { return make_unique<GenericPokerDomain>(3,2,2,2,2,1); }},
        {"GP_large",   [ ](vector<string>)   { return make_unique<GenericPokerDomain>(4,6,4,4,4,1); }},
        {"LD_116",     [ ](vector<string>)   { return make_unique<LiarsDiceDomain>(vector<int>{1, 1}, 6); }},
        {"LD_226",     [ ](vector<string>)   { return make_unique<LiarsDiceDomain>(vector<int>{2, 2}, 6); }},
        {"LD_tiny",    [ ](vector<string>) { return make_unique<LiarsDiceDomain>(vector<int>{1, 1}, 3); }},
        {"LD_small",   [ ](vector<string>)   { return make_unique<LiarsDiceDomain>(vector<int>{1, 1}, 6); }},
        {"LD_large",   [ ](vector<string>)   { return make_unique<LiarsDiceDomain>(vector<int>{2, 2}, 6); }},
        {"simple_poker", [ ](vector<string>) { return make_unique<SimplePokerDomain>(); }},
        {"STRAT2x2",   [ ](vector<string>)   { return make_unique<StrategoDomain>(StrategoSettings{2,2,{},{'1', '2'}}); }},
        {"STRAT2x3",   [ ](vector<string>)   { return make_unique<StrategoDomain>(StrategoSettings{2,3,{},{'1', '2', '3'}});}},
        {"STRAT3x2",   [ ](vector<string>)   { return make_unique<StrategoDomain>(StrategoSettings{3,2,{},{'1', '2'}});}},
        {"STRAT3x3",   [ ](vector<string>)   { return make_unique<StrategoDomain>(StrategoSettings{3,3,{{1,1,1,1}},{'1', '2', '3'}});}},
        {"STRAT4x4",   [ ](vector<string>)   { return make_unique<StrategoDomain>(StrategoSettings{4,4,{{1,1,2,2}}, {'3','2','2','1'}});}},
        {"STRAT6x6",   [ ](vector<string>)   { return make_unique<StrategoDomain>(StrategoSettings{6,6,{{2,2,2,2}}, {{'B',1},{'4',1},{'3', 2},{'2', 3}, {'1', 4}, {'F', 1}}});}},
        {"STRAT10x10", [ ](vector<string>)   { return make_unique<StrategoDomain>(StrategoSettings{10,10, {{3,5,2,2}, {7,5,2,2}},{{'B', 6},{'9', 1},{'8', 1},{'7', 2},{'6', 3},{'5', 4},{'4', 4}, {'3', 4}, {'2', 5}, {'1', 8}, {'0', 1}, {'F', 1}}}); }},
        {"KS",         [ ](vector<string>)   { return make_unique<KriegspielDomain>(1000, 1000, chess::BOARD::STANDARD); }},
        {"KS_STANDARD",      [ ](vector<string>) { return make_unique<KriegspielDomain>(1000, 1000, chess::BOARD::STANDARD); }},
        {"KS_SILVERMAN4BY4", [ ](vector<string>) { return make_unique<KriegspielDomain>(30, 30, chess::BOARD::SILVERMAN4BY4); }},
        {"KS_MINIMAL4x3",    [ ](vector<string>) { return make_unique<KriegspielDomain>(1000, 1000, chess::BOARD::MINIMAL4x3); }},
        {"KS_MICROCHESS",    [ ](vector<string>) { return make_unique<KriegspielDomain>(1000, 1000, chess::BOARD::MICROCHESS); }},
        {"KS_DEMICHESS",     [ ](vector<string>) { return make_unique<KriegspielDomain>(1000, 1000, chess::BOARD::DEMICHESS ); }},
    };
    // @formatter:on
