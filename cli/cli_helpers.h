...
unique_ptr<Domain> constructDomain(const string &description) {
    ...
    unordered_map<string, function<unique_ptr<Domain>(vector<string>)>> domainsTable = {
        ...
        {"STRAT6x6",   [ ](vector<string>)   { return make_unique<StrategoDomain>(StrategoSettings{6,6,{{2,2,2,2}}, {'B','4','3','3','2','2', '2','1','1','1','1','F'}});}},
        {"STRAT10x10", [ ](vector<string>)   { return make_unique<StrategoDomain>(StrategoSettings{10,10, {{3,5,2,2}, {7,5,2,2}}}); }},
