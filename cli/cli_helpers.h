...
unique_ptr<Domain> constructDomain(const string &description) {
    ...
    unordered_map<string, function<unique_ptr<Domain>(vector<string>)>> domainsTable = {
        ...
        {"STRAT6x6",   [ ](vector<string> p) { return make_unique<StrategoDomain>(StrategoSettings{6,6,{{2,2,2,2}}, {{'B',1},{'4',1},{'3', 2},{'2', 3}, {'1', 4}, {'F', 1}}});}},
        {"STRAT10x10", [ ](vector<string> p) { return make_unique<StrategoDomain>(StrategoSettings{10,10, {{3,5,2,2}, {7,5,2,2}},{{'B', 6},{'9', 1},{'8', 1},{'7', 2},{'6', 3},{'5', 4},{'4', 4}, {'3', 4}, {'2', 5}, {'1', 8}, {'0', 1}, {'F', 1}}}); }},
