...
public:
    ...
    Exp3SelectorFactory(double minUtility, double maxUtility, double gamma, bool storeExploration, std::mt19937 random):
        minUtility_(minUtility), maxUtility_(maxUtility), gamma(gamma), storeExploration(storeExploration), generator_(random) {}
    Exp3SelectorFactory(double minUtility, double maxUtility, double gamma, bool storeExploration, int seed):
        minUtility_(minUtility), maxUtility_(maxUtility), gamma(gamma), storeExploration(storeExploration)
            {generator_ = std::mt19937(seed);}
    Exp3SelectorFactory(double minUtility, double maxUtility, double gamma, bool storeExploration):
        minUtility_(minUtility), maxUtility_(maxUtility), gamma(gamma), storeExploration(storeExploration)
            {generator_ = std::mt19937(0);}

    Exp3SelectorFactory(bool useExp3L, double minUtility, double maxUtility, double gamma, std::mt19937 random):
        minUtility_(minUtility), maxUtility_(maxUtility), gamma(gamma), useExp3L(useExp3L), generator_(random) {}
