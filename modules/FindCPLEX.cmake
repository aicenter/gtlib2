...
#if(CPLEX_CONCERT_LIBRARY AND CPLEX_CONCERT_LIBRARY_DEBUG AND CPLEX_CONCERT_INCLUDE_DIR)
  find_package_handle_standard_args(
...
# TRUE if all listed variables are TRUE.
#if( CPLEX_ILOCPLEX_LIBRARY AND CPLEX_ILOCPLEX_LIBRARY_DEBUG AND CPLEX_ILOCPLEX_INCLUDE_DIR AND CPLEX_FOUND AND CPLEX_CONCERT_FOUND)
  find_package_handle_standard_args(
...
# if all listed variables are TRUE.
#if( CPLEX_CP_LIBRARY AND CPLEX_CP_LIBRARY_DEBUG AND CPLEX_CP_INCLUDE_DIR AND CPLEX_CONCERT_FOUND)
find_package_handle_standard_args(
