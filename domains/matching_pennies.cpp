...
bool MatchingPenniesState::operator==(const State &rhs) const {
    ...
    return player1_ == mpState.player1_ && player2_ == mpState.player2_
...
bool SimultaneousMatchingPenniesState::operator==(const State &rhs) const {
    auto mpState = dynamic_cast<const SimultaneousMatchingPenniesState &>(rhs);
    return player1_ == mpState.player1_ && player2_ == mpState.player2_
        && players_ == mpState.players_;
}
