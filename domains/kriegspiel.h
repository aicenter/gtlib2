...
namespace GTLib2 {
    namespace domains {
        ...
        public:
             ...
             */
            KriegspielState(Domain *domain, int, int, int, shared_ptr<vector<shared_ptr<AbstractPiece>>> pieces,
                    chess::Square enPassantSquare, shared_ptr<vector<shared_ptr<KriegspielAction>>>, int, bool,
