...
#ifndef GTLIB_NORMALFORMLP_H
#define GTLIB_NORMALFORMLP_H
 ...
 * The class does not hold the copy of the utility matrix (only a pointer) and directly builds the LP.
...
protected:
    ...
    const vector<double>* utility_matrix_ = nullptr;
